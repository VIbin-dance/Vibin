...
export declare type CreateChannelCommandInput = CreateChannelRequest;
export declare type CreateChannelCommandOutput = CreateChannelResponse & __MetadataBearer;
/**
