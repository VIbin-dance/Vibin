...
export declare type CreateStreamKeyCommandInput = CreateStreamKeyRequest;
export declare type CreateStreamKeyCommandOutput = CreateStreamKeyResponse & __MetadataBearer;
/**
