...
export declare type ListStreamKeysCommandInput = ListStreamKeysRequest;
export declare type ListStreamKeysCommandOutput = ListStreamKeysResponse & __MetadataBearer;
/**
