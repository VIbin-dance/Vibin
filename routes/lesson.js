...
router.post('/create_channel', ensureAuthenticated, async (req, res) => {
    ...
    // const GetRecord_option = {
    //     arn: "arn:aws:ivs:us-west-2:796149191138:recording-configuration/kxknEpUFfqcs"
    // };

    // const GetRecord = new GetRecordingConfigurationCommand(GetRecord_option);
    const CreateRecord = new CreateRecordingConfigurationCommand(CreateRecord_option);
    console.log(CreateRecord_option);
